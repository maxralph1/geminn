    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_price', models.DecimalField(decimal_places=2, help_text='Maximum 999.99', max_digits=5, verbose_name='Delivery Price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Required', max_length=255, verbose_name='Payment selection Name')),
                ('is_active', models.BooleanField(default=True)),
            ],
            options={
